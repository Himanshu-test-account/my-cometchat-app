...
import CloseIcon from '../../assets/close.svg'; // Adjust the path as needed
    ...
    <>
      <div className="cometchat-user-details__header">
        ...
        <div
          ...
          style={{
            WebkitMask: `url(${CloseIcon}) center center / contain no-repeat`,
            mask: `url(${CloseIcon}) center center / contain no-repeat`,
            backgroundColor: 'var(--cometchat-icon-color-primary, #141414)',
            width: '24px',
            height: '24px',
            cursor: 'pointer',
          }}
