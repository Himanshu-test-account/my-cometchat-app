...
function CometChatBuilderApp({ user, group }: CometChatHomeProps) {
  ...
  // Create a logout button component that can be included alongside CometChatHome
  const LogoutButton = () => (
    <button 
      className="cometchat-logout-button"
      ...
      style={{
        ...
        zIndex: 1000,
        padding: '8px 16px',
        backgroundColor: 'var(--cometchat-primary-color, #2196f3)',
        color: 'white',
        border: 'none',
        borderRadius: '4px',
        cursor: 'pointer'
